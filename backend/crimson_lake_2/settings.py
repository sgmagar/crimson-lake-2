"""
Django settings for crimson_lake_2 project.
...
ROOT_URLCONF = 'crimson_lake_2.urls'
...
WSGI_APPLICATION = 'crimson_lake_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_lake_2 API",
    "DESCRIPTION": "API documentation for crimson_lake_2 App",
    "VERSION": "v1",
}
